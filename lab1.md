...
1. What is the name of the distribution and the OS Type: 
   * **Distro is BEE free and OS is Linux**
...
**In my opinion, GamerOS is easy to use, and the updates requires no user input. It is an operating system that will give you the best gaming experience. The distro has been submitted on 06-12-2020 and it is waiting for evaluation. It is easy to install, and you can start gaming without any configuration. Also, you can use any controller, such as Xbox 360, Xbox One, DualShock 3 & 4, Switch Pro, Steam controllers and more.**
